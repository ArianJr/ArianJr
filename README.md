...
|-------------------------------------------|-----------------------------------------------------------------------------|----------------------------------------------------------------------------|------------------------------------------------------------------------------|
| CNN Image Classifier | Modular CNN built with TensorFlow/Keras, includes training notebook, sample dataset, and performance plots | [View Repo](https://github.com/ArianJr/cnn-image-classifier) |
